...
| RNF-010 | Adaptar layout a pantalla completa. | El layout debe estar diseñado para que todo el contenido principal quede contenido en un único viewport en todas las plataformas (Mobile, Tablet, Desktop y TV), sin necesidad de scroll vertical ni horizontal. | Completado |
