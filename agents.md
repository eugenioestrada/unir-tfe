...
- Capture UI and marketing screenshots using real device viewports (Mobile M, Mobile L, Tablet, PC, TV 1080p, TV 4K) to validate non-functional requirements before submission.
